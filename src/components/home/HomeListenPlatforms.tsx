...
export default function HomeListenPlatforms() {
  return (
    <div className="space-y-4">
      <p className="text-lg font-normal leading-8 text-white/68">
        <span className="font-semibold text-accent/90">四大平台</span>任你收聽
      </p>
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        >
          ...
          <span className="text-sm font-medium text-white/88">Apple Podcasts</span>
        </a>
        ...
        >
          ...
          <span className="text-sm font-medium text-white/88">Spotify</span>
        </a>
        ...
        >
          ...
          <span className="text-sm font-medium text-white/88">YouTube</span>
        </a>
        ...
        >
          ...
          <span className="text-sm font-medium text-white/88">KKBOX</span>
        </a>
      </div>
    </div>
  );
